...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,				XK_x,					   spawn,		   {.v = kittyfloatcmd } },
...
/*    { MODKEY,                       XK_w,                      spawn,          SHCMD ("looking-glass-client -F")},*/
    ...
    { 0,                            XF86XK_AudioLowerVolume,   spawn,          SHCMD ("amixer sset Master 1%- unmute")},
    { 0,                            XF86XK_AudioMute,          spawn,          SHCMD ("amixer sset Master $(amixer get Master | grep -q '\\[on\\]' && echo 'mute' || echo 'unmute')")},
    { 0,                            XF86XK_AudioRaiseVolume,   spawn,          SHCMD ("amixer sset Master 1%+ unmute")},
