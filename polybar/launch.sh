...
CONFIG_FILE="$HOME/.local/share/dwm-sid/polybar/themes/$THEME/config.ini"
LAPTOP_CONFIG_FILE="$HOME/.local/share/dwm-sid/polybar/themes/$THEME/laptop-config.ini"
